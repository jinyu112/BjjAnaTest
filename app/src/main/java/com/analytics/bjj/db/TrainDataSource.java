...
import com.analytics.bjj.Train;
...
public class TrainDataSource {
    ...
    public void removeAllTrains() {
        database.execSQL("delete from " + trainingDBOpenHelper.TABLE_TRAIN);
    }
    ...
    public void update(Train train) {
        ...
        values.put(trainingDBOpenHelper.COLUMN_TD_SUCCESS_TRAIN,train.getTdSuccessful());
        values.put(trainingDBOpenHelper.COLUMN_MATCH_TIME_TRAIN,train.getMatchTime());
        database.update(trainingDBOpenHelper.TABLE_TRAIN,values,trainingDBOpenHelper.COLUMN_ID_TRAIN + "=" + train.getId(),null);
